        ...
        <aside class="c-attr-wrap">
          <section class="ml20 mr15">
            ...
            <section class="c-attr-jg">
              ...
              <b class="c-yellow"
                 style="font-size:24px;">￥{{ course.price}}</b>
            </section>
            ...
            <section v-if="flag || Number(course.price)===0"
                     class="c-attr-mt">
              <a href="#"
                 title="立即观看"
                          ...
                          <li v-for="chapter in chapterList"
                            ...
                            <ol class="lh-menu-ol"
                              ...
                              <li v-for="video in chapter.children"
                                ...
                                <!-- target="_blank" 表示在新的标签页打开链接内容 -->
                                <a :href="'/player/'+video.videoSourceId"
                                   target="_blank">
                                  <span v-if="video.free === true"
                                        class="fr">
      ...
      <div>
        ...
        <section class="">
          <section class="question-list lh-bj-list pr">
            <ul class="pr10">
              <li v-for="(comment,index) in data.list"
                  v-bind:key="index">
                <aside class="noter-pic">
                  <img width="50"
                       height="50"
...
export default {
  ...
  methods: {
    ...
    initComment () {
      comment.getCommentList(this.courseId, this.page, this.limit).then(response => {
    ...
    gotoPage (page) {
      comment.getCommentList(this.courseId, page, this.limit).then(response => {
        this.data = response.data.data
      })
    }
  }
